export default function AboutUs() {
    return (
        ...
        box-border">
            <h1
            className="w-full text-6xl text-center font-black font-serif pb-[5%] max-sm:pb-[2%]"
            >
                About Us</h1>
            <p>Founded in 2023, Rafba Soft began its journey with a simple vision — to empower businesses through smart, custom-built software solutions. Starting with ERP systems developed in Oracle, we quickly gained recognition for crafting high-performance, business-specific applications that simplify operations and drive growth.
                ...
                Driven by innovation, fueled by customer success, and built on trust — Rafba Soft is now growing rapidly, serving both local and international clients with a commitment to quality, scalability, and digital transformation.</p>
        </main>
    )
}